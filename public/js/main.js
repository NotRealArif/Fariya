...
function sendMessage(message, ai_name, time){
  $('#chat_area').append('<div><img src="' + logo + '" style="height:30px; width:30px; position:relative; top:15px; left:10px;">' +
      '<span style="font-size:13px; position:relative; top:7px; color: white; left:15px;"><i><strong>' + ai_name + '</strong>: ' + message + '</i></span><br>' + 
      '<span style="font-size:11px; position:relative; top:-2px; color: white; left:50px;">' + time + '</span><br>' + 
